...
class HotkeyManager:
    ...
    def _socket_listen_loop(self):
        ...
        while self._running:
            try:
                ...
                # Parse optional cursor position: "capture_region@1234,567"
                cursor_pos = None
                name = data
                if "@" in data:
                ...
                if name in self._listeners:
                    ...
                    # Pass cursor_pos if the callback accepts it
                    try:
    ...
    def _register_gnome_shortcuts(self):
        ...
        display_names = {
            ...
            "start_recording": "BazzCap: Record Video",
            "start_gif": "BazzCap: Record GIF",
        }
